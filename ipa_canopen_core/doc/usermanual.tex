...
pdfauthor={Thiago de Freitas Oliveira Araujo, Eduard Herkel, Tobias Sing},pdfsubject={IPA CANopen user Manual},
pdfkeywords={CANOpen, ROS, setup, install, manual}]{hyperref}
...
\include{tools}
% \include{using_rosindependentlibrary}
\include{roscanopen}
\include{extending}
